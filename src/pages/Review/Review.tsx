      ...
      >
        {products.data?.map((product: TProducts) => (
          <SwiperSlide key={product._id} className='p-4'>
            <div className="flex flex-col items-center border rounded-lg shadow-md  bg-gradient-to-t from-amber-200 to-amber-100 hover:bg-gradient-to-b  shadow-orange-950">
              <img
                src={product.image}
                alt={product.name}
